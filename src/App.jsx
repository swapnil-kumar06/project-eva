...
export default function App() {
  ...
  const sendMessage = async () => {
    ...
    try {
      ...
      setMessages((prev) => [
        ...prev,
        { type: "bot", text: "Sorry, I am unable to respond at the moment." },
      ]);
    } finally {
      setIsTyping(false);
    }
  ...
  return (
    ...
    >
      ...
      <header
        ...
        } border-b border-gray-600 p-4 rounded-b-xl`}
      >
        <div className="flex justify-between items-center max-w-4xl mx-auto w-full">
          ...
          <div className="flex gap-2">
            ...
            <button
              onClick={toggleTheme}
              className="bg-gray-500 text-white px-3 py-2 rounded-md hover:bg-gray-400"
            >
              <Moon size={18} />
            </button>
          </div>
      ...
      <div className="flex-1 overflow-y-auto px-4 py-4 flex flex-col gap-4 max-w-4xl mx-auto w-full">
        ...
        {isTyping && (
          <div className="italic text-sm opacity-70">Eva is typing...</div>
        )}
      ...
      <div
        className={`${
          isDark ? "bg-gray-800" : "bg-gray-100"
        } p-4 flex gap-2 max-w-4xl mx-auto w-full border-t border-gray-600`}
      >
        <input
          type="text"
